...
func healthSummary(pg store.Store) gin.HandlerFunc {
...
func healthHistory(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func healthTrend(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func locationLatest(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func locationHistory(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func geofenceSet(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
		var req struct {
...
func geofenceList(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func geofenceUpdate(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func geofenceDelete(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		gfID := c.Param("geofence_id")
...
func medRules(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func medCreateRule(pg store.Store, nats *service.NatsClient) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func medUpdateRule(pg store.Store, nats *service.NatsClient) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func medDeleteRule(pg store.Store, nats *service.NatsClient) gin.HandlerFunc {
	return func(c *gin.Context) {
		ruleID, exists := c.Get("rule_id")
		if !exists {
			c.JSON(400, gin.H{"code": "MISSING_RULE_ID", "message": "rule_id required"})
...
func medToday(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
...
func medHistory(pg store.Store) gin.HandlerFunc {
	return func(c *gin.Context) {
		elderlyID := c.Param("elderly_id")
		days, _ := strconv.Atoi(c.DefaultQuery("days", "30"))
		if days < 1 || days > 365 {
