...
func migrate(db *sql.DB) error {
	migrations := []string{
		...
		`ALTER TABLE health_records ADD COLUMN source TEXT`,
		...
		`ALTER TABLE health_records ADD COLUMN temperature REAL`,
		...
		`ALTER TABLE medication_rules ADD COLUMN business_chain TEXT`,
		`ALTER TABLE medication_rules ADD COLUMN source_type TEXT`,
		...
		`ALTER TABLE medication_rules ADD COLUMN drug_category TEXT`,
		`ALTER TABLE medication_rules ADD COLUMN dosage TEXT`,
		`ALTER TABLE medication_rules ADD COLUMN frequency TEXT`,
		`ALTER TABLE medication_rules ADD COLUMN route TEXT DEFAULT 'oral'`,
		...
		`CREATE TABLE IF NOT EXISTS person_profiles (
			...
			created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
			updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
			UNIQUE(person_id, business_chain)
		)`,
