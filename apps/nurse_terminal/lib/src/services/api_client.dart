...
/// HTTP client for the api-server (JWT-authenticated).
/// Used by the nurse terminal to access patient data and write verification/ward round records.
class ApiClient {
  final String baseUrl;
  String? _token;

  ApiClient({this.baseUrl = 'http://localhost:8085'});
