        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: alert.severity == 'P0' ? AppTheme.statusDanger : AppTheme.statusWarning,
                shape: BoxShape.circle,
              ),
            ),
            Expanded(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: alert.status == 'pending' ? const Color(0xFFFFEBEE) : const Color(0xFFE8F5E9),
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: alert.status == 'pending' ? const Color(0xFFC62828) : const Color(0xFF2E7D32),
                ),
              ),
            ),
          ],
